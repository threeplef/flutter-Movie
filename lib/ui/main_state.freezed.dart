...
class _$_MainState implements _MainState {
  const _$_MainState({final List<Movie> movies = const []}) : _movies = movies;
  ...
  @override
  String toString() {
    return 'MainState(movies: $movies)';
  }
...
abstract class _MainState implements MainState {
  const factory _MainState({final List<Movie> movies}) = _$_MainState;
