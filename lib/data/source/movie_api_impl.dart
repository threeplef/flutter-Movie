...
class MovieApiImpl implements MovieApi {
  ...
  @override
  Future<MovieDto> getSortedMovieListByTitle() async {
    Uri url = Uri.parse(
        'https://api.themoviedb.org/3/movie/upcoming?api_key=a64533e7ece6c72731da47c9c8bc691f&language=ko-KR&page=1');

    return MovieDto.fromJson(jsonDecode((await _client.get(url)).body));
  }

  @override
  Future<MovieDto> getSortedMovieListByVoteAverage() async {
    Uri url = Uri.parse(
        'https://api.themoviedb.org/3/movie/upcoming?api_key=a64533e7ece6c72731da47c9c8bc691f&language=ko-KR&page=1');
